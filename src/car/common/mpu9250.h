...
#ifndef ZERO_MPU9250_H
#define ZERO_MPU9250_H
...
namespace Navio{
    class MPU9250 : public InternalSensor{
    public:
        MPU9250(){}
    ...
    private:
        ...
        void readRegs(uint8_t readAddr, uint8_t *buff, uint32_t bytes);
